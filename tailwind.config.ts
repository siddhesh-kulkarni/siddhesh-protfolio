  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'card-gradient': 'linear-gradient(180deg, hsl(var(--card-bg)), hsl(var(--secondary)))',
      },
      boxShadow: {
        'card': '0 4px 20px -2px hsl(var(--card-shadow))',
        'card-hover': '0 8px 30px -4px hsl(var(--card-shadow))',
      },
      transitionProperty: {
